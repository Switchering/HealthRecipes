...
<!--                            <ul>
                    ...
                    <div class="section-row">
                        <div class="post-nav">
                            <div class="prev-post">
                                <a class="post-img" href="blog-post.html"><img src="<?= $previous->getImage()?>" alt=""></a>
                                <h3 class="post-title"><a href="#"><?= $previous->title?></a></h3>
                                <span>Предыдущий пост</span>
                            </div>

                            <div class="next-post">
                                <a class="post-img" href="blog-post.html"><img src="<?= $next->getImage()?>" alt=""></a>
                                <h3 class="post-title"><a href="#"><?= $next->title?></a></h3>
                    ...
                    <div class="section-row">
                        <div class="section-title">
                                <h3 class="title">О <a href="author.html"><?=$article->author->name?></a></h3>
                        </div>
